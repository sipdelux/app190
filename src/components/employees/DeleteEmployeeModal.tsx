      ...
      <div className="bg-white rounded-lg max-w-md w-full p-6">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Удаление сотрудника</h2>
          </div>
        ...
        <div className="mb-6">
          <p className="text-gray-700 mb-2">
            Вы собираетесь удалить сотрудника <span className="font-medium">{employeeName}</span>.
            Выберите действие:
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="text-sm text-gray-500 mt-1">
              Сотрудник будет удален, но история транзакций сохранится
            </div>
          </button>
